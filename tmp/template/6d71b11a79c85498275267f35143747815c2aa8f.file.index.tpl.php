<?php /* Smarty version Smarty-3.1.8, created on 2014-08-22 11:21:37
...
views/index/img/mision_vision_proindusquim.png" alt="Eddie" class="eddie" />   
                    ...
                    <p>Elaboración de productos químicos industriales y servicios afines de calidad, siendo responsables con el ambiente, nuestros trabajadores y la sociedad en general.</p><br/><br/><br/>
...
views/index/img/mision_vision_proindusquim.png" alt="Eddie" class="eddie" />   
        ...
        <div id="barra_productos">
            <div class="left-footer-productos">
                <div class="centrado bloque_titulos subtitulo-4 rojo"> INSTITUCIONAL / HOGAR</div>
                <div class="centrado bloque_titulos subtitulo-4 rojo"> ANTIHUMEDAD</div>
...
views/index/img/antihumedad2.jpg" />
                    <div class="valores_presentacion"><b class="bloque_titulos">Presentación:</b><br/><div class="cuadro_presentacion">10 l</div></div>
                </div>
            ...
            <div class="left-footer-productos">
                <div class="centrado bloque_titulos subtitulo-4 rojo"> CONSTRUCCIÓN</div>
                <div class="centrado bloque_titulos subtitulo-4 rojo"> LAVADOR 50</div>
                <div class="descripcion_productos">
...
views/index/img/antihumedad2.jpg" />
            ...
            <div class="left-footer-productos">
                <div class="centrado bloque_titulos subtitulo-4 rojo"> INDUSTRIAL</div>
                <div class="centrado bloque_titulos subtitulo-4 rojo"> DS-30 BIO</div>
                <div class="descripcion_productos">
                    <p><b class="rojo">Descripción:</b><br/>Limpiador desengrasante multiuso alta biodegradabilidad.</p><br/>
                    <p><b class="rojo">Usos:</b><br/>Superficies en general.</p>
                    <p>Para reforzar lavado de ropa en máquina o manual.</p><br/>
