            ...
            <div id="barra_productos_derecha">
                <div class="left-footer-productos">
                    <div class="cuadro_productos">
                        ...
                        <div class="imagen_productos">
                            <img src="{$_layoutParams.root}views/institucional_hogar/img/no_disponible.jpg" />
                ...
                <div class="left-footer-productos">
                    <div class="cuadro_productos">
                        <div class="centrado bloque_titulos subtitulo-4 blanco">CLORO 100 al 5%</div>
                            ...
                            <div class="imagen_productos">
                                <img src="{$_layoutParams.root}views/institucional_hogar/img/cloro_100.jpg" />
                ...
                <div class="left-footer-productos">
                    <div class="cuadro_productos">
                        ...
                        <div class="imagen_productos">
                            <img src="{$_layoutParams.root}views/institucional_hogar/img/ds30.jpg" />
